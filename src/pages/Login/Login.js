            ...
            <div className="lg:w-1/2 xl:max-w-screen-sm">
                <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div className="cursor-pointer flex items-center">
                        ...
                        <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Lương Việt Trí</div>
                    </div>
                </div>
                <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2 className="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">Đăng nhập hoy</h2>
                    <div className="mt-12">
                        <form onSubmit={(event) => {
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Nhập tài khoản hoy" />
                            </div>
                            <div className="mt-8">
                                ...
                                <input
                                    name="matKhau"
                                    onChange={formik.handleChange}
                                    className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Nhập pass vô nghen" />
                            </div>
                            <div className="mt-10">
                        ...
                        <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Chưa có tài khoản hửm? <a className="cursor-pointer text-indigo-600 hover:text-indigo-800">Đăng ký hoy</a>
                        </div>
                    </div>
                </div>
            </div>
